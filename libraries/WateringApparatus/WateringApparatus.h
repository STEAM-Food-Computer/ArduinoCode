...
const static int pollingInterval = 30000; //how often to read data from the sensors, in future, make this modifiable
...
private:
    ...
    static void readAllSensors();  //will actually read the values from the sensors into the array when ready
